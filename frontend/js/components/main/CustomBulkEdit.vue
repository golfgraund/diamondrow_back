            ...
            <div slot="dropdown__content">
              <ul>
                <li>
                    ...
                    <button @click="bulkExportPDF">Скачать PDF</button>
                    <button @click="bulkExportXLS">Скачать XLS</button>
                </li>
              </ul>
            </div>
          </a17-dropdown>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      bulkExport: function ($inverse = false) {
        this.$store.dispatch(ACTIONS.BULK_EXPORT)
      },
      bulkExportPDF: function () {
        this.$store.dispatch(ACTIONS.BULK_EXPORT_PDF)
      },
      bulkExportXLS: function () {
        this.$store.dispatch(ACTIONS.BULK_EXPORT_XLS)
      },
      bulkDelete: function () {
