      ...
      <div class="multiselector" :class="gridClasses">
        <div class="multiselector__outer">
          <div class="multiselector__item"
               ...
               :style="itemStyle"
            >
            <input class="multiselector__checkbox" :class="{'multiselector__checkbox--checked': checkedValue.includes(checkbox.value) }" type="checkbox" :value="checkbox.value" :name="name +   '[' + index + ']'" :id="uniqId(checkbox.value, index)" :disabled="checkbox.disabled || disabled" v-model="checkedValue">
