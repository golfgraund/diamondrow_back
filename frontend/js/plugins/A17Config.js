...
import A17CustomBulkEditor from '@/components/main/CustomBulkEdit.vue'
import A17CustomMultiSelect from '@/components/main/CustomMultiSelect.vue'
import A17CustomSingleSelect from '@/components/main/CustomSingleSelect.vue'
...
const A17Config = {
  install (Vue, opts) {
    ...
    Vue.component('a17-custom-bulk-editor', A17CustomBulkEditor)
    Vue.component('a17-custom-multi-select', A17CustomMultiSelect)
    Vue.component('a17-custom-single-select', A17CustomSingleSelect)
